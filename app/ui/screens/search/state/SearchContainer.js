...
import { GetWatchlistCoinsResourceMapper } from "../../../../shared/GetWatchlistCoinsResource";
import {
...
function mapStateToProps(state) {
    ...
    const getWatchlistCoinsResourceMapper = GetWatchlistCoinsResourceMapper("search", state);
