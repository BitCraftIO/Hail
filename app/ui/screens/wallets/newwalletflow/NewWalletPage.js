    ...
    createWallet() {
        ...
        if (this.state.type == 'exchange') {
            ...
            var options = {
                ...
                receiveAddresses: ['receiveAddr 1'],
            ...
            <View>
                ...
                <View style={{ paddingTop: 30 }}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View>
                            <CheckBox title="XMR" checked={this.state.xmrchecked} onPress={() => this._pressWalletTypeCheckBox('XMR')} />
                        </View>
                    </View>
                </View>

                <Button title={'Create Wallet'} onPress={() => this.createWallet()} />
